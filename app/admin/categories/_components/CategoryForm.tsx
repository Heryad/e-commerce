...
// Note: useActionState is React 19 / Next 15. If Next 16, it works.
// We'll stick to simple form action for now to ensure compatibility if experimental.
// Actually standard form action is fine.

export default function CategoryForm({ action, initialData }: { action: any, initialData?: any }) {
